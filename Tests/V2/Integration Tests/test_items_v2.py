...
class TestItems(unittest.TestCase):
    def setUp(self):
        self.items = httpx.Client(headers={'API_KEY': 'a1b2c3d4e5'})
    ...
    def test_01_get_items(self):
        ...
        response = self.items.get(f"{self.url}/items")
    ...
    def test_02_get_item_by_id(self):
        ...
        response = self.items.get(f"{self.url}/items/P000005")
    ...
    def test_05_post_item(self):
        ...
        response = self.items.post(f"{self.url}/items", json=data)
    ...
    def test_06_put_item(self):
        ...
        response = self.items.put(f"{self.url}/items/P000001", json=data)
...
#unhappy test item -> existing id, invalid structure
    ...
    def test_08_unhappy_post_existing_id(self):
        ...
        response = self.items.post(f"{self.url}/items", json=existing_item)
