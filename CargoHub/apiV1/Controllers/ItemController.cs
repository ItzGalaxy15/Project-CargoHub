...
namespace apiV1.Controllers
{
    ...
    public class ItemController : Controller
    {
        ...
        {
            Item? existingItem = this.itemService.GetItemById(item.Uid);
            Item? oldItem = this.itemService.GetItemById(item.Uid);
            ...
            await this.itemService.UpdateItem(item, item.Uid);
            return this.Ok();
        }
